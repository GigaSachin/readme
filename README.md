...
const sachin = {
    ...
    currentBuild: "Milkkart — rural-to-urban dairy delivery startup",
    status: "Open to freelance / full-time opportunities",
    fact: "I ship real products, not just demos"
};
```
...
pricing, cold-chain delivery, zero-wastage surplus processing.
...
custom cursor, parallax hero, interactive depth explorer.
`HTML` `Canvas` `Creative Frontend`
...
charts, live alerts, refinery status, on-brand orange/navy theme.
